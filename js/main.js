...
myImmutableArray.push = ["Wilhelm","Hamish","Janice"];
...
let arr = ["Jared","Amrit", "Sarah", "Gurleen", "Johanna", "Ury"];

let filteredArr = arr.filter(item => !item.startsWith('J'));

console.log(filteredArr); // ['Jared', 'Johanna']
